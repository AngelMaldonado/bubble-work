...
> is not updated when the system moves on. For what is true today, read [`modules/artifacts.md`](../modules/artifacts.md) and [`modules/documents.md`](../modules/documents.md).
