...
> is not updated when the system moves on. For what is true today, read [`modules/pages.md`](../modules/pages.md).

## The problem

[the model](../../README.md) §2.5 gives a Workspace a place for
