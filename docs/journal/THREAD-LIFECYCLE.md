...
[`AGENTS.md`](../../AGENTS.md). (It also cited `INTERIOR-PLAN.md`, a worksheet
retired once the thread interior shipped; its content lives in
[`modules/threads.md`](../modules/threads.md).)
...
> is not updated when the system moves on. For what is true today, read [`modules/threads.md`](../modules/threads.md) and [`modules/heat.md`](../modules/heat.md).
