...
const en = {
  ...
  'thread.dodBlocked': 'The Definition of Done is not met yet.',
  'thread.forceDone': 'finish anyway',
...
const es: Record<MsgKey, string> = {
  ...
  'thread.dodBlocked': 'La Definición de Terminado aún no se cumple.',
  'thread.forceDone': 'terminar de todas formas',
