...
func (s *Server) Handler() http.Handler {
	...
	// project pages: reference material for a workspace (docs, specs)
	mux.HandleFunc("GET /api/workspaces/{id}/pages", s.restAuth(s.handlePages))
	mux.HandleFunc("POST /api/workspaces/{id}/pages", s.restAuth(s.handleCreatePage))
	mux.HandleFunc("GET /api/pages/{id}", s.restAuth(s.handlePage))
	mux.HandleFunc("PATCH /api/pages/{id}", s.restAuth(s.handleUpdatePage))
	mux.HandleFunc("DELETE /api/pages/{id}", s.restAuth(s.handleDeletePage))
	...
	mux.HandleFunc("DELETE /api/threads/{id}", s.restAuth(s.handleDeleteThread))
	mux.HandleFunc("DELETE /api/threads/{id}/regions/{region}", s.restAuth(s.handleDeleteRegion))
